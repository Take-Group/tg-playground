...
- Uruchamianie wyłącznie przez Docker — jedyny sposób to `docker compose up --build` z katalogu głównego (jeden `Dockerfile`, jeden `compose.yaml`, backend i frontend w jednym kontenerze)
